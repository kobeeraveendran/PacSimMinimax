...
class Node
{
    ...
    public Node(double value, PacCell[][] newState)
    {
...
public class PacSimMinimaxOld implements PacAction
{
    ...
    public PacSimMinimaxOld(int depth, String fname, int te, int gran, int max)
    {
    ...
    public static void main(String[] args)
    {
        ...
        new PacSimMinimaxOld(depth, fname, te, gr, ml);
